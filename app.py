...
if "Dashboard" in selected_page:
    ...
    # Loaded state (Pipeline page)
        ...
        with col_left:
            ...
            run_btn = st.button("▶  Run Hybrid Ranker", type="primary", width="stretch")
    ...
    # Results state
        ...
        with tab2:
            ...
            st.dataframe(df_breakdown, width="stretch", height=520,
                column_config={
                    "Rank": st.column_config.NumberColumn(width="small"),
...
# -----------------
    ...
    if lb_candidates:
        ...
        st.dataframe(df_lb, width="stretch", height=450,
                     column_config={
                         "Hybrid Score": st.column_config.ProgressColumn(min_value=0, max_value=100, format="%.2f"),
...
# -----------------
    ...
    with col2:
        ...
        apply_btn = st.button("Apply Config", type="primary", width="stretch")
        reset_btn = st.button("Reset defaults", type="secondary", width="stretch")
